...
export default function Contact() {
    ...
    const queryTypes = [
        { value: 'plant-care', label: 'Plant Care Help' },
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-[#fff9ed] rounded-xl shadow-lg border border-[#e6d5bc] p-8">
                            <h2 className="text-2xl font-semibold text-[#22c55e] mb-6">
                                Contact Information
                            </h2>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[#22c55e] font-medium">support@plantid.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800">24/7 Support</p>
                                    </div>
                                </div>
                            </div>

                            {/* Social Links */}
                            <div className="mt-8 pt-8 border-t border-[#e6d5bc]">
                                <h3 className="text-lg font-semibold text-[#22c55e] mb-4">Follow Us</h3>
                                <div className="flex space-x-4">
                                    {/* Add your social media links here */}
                                    <a href="#" className="bg-[#22c55e] p-2 rounded-full text-white hover:bg-[#16a34a] transition-colors">
                        ...
                        <div className="bg-[#fff9ed] rounded-xl shadow-lg border border-[#e6d5bc] p-8">
                            {submitted ? (
                                ...
                                <form className="space-y-6" onSubmit={(e) => {
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-[#22c55e] text-white py-3 rounded-lg font-semibold hover:bg-[#16a34a] transition-colors"
                                    >
                                        Send Message
                                    </button>
                                </form>
